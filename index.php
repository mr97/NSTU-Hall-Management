		...
		<div class="">
			<div class="row">
				...
				<div class="col-md-5 p-3 mx-auto">
					...
					<hr>
					<p>It is my pleasure to introduce you to one of the vibrant Technological institutes in Bangladesh. Computer Science And Telecommunication Engineering (CSTE), Noakhali Science and Technology University. The Computer Science And Telecommunication Engineering (CSTE) has been established under Noakhali Science and Technology
					...
					<div class="col">
						<div class="card" style="width: 18rem;">
							...
							<div class="card-body">
								...
								<p class="card-text">It is my great pleasure to welcome you all to Nstu Hall Management System. I’m delighted to see you here. </p>
